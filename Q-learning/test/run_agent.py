...
def update(epoch):
    ...
    for episode in range(epoch):
        ...
        while True:
            ...
            observation_, _, done = env.step('down')
...
if __name__ == "__main__":
    ...
    RL = QLearningTable(actions=list(['left', 'right', 'None', 'speedup', 'slowdown']))
    # Running the main loop with Episodes by calling the function update()
    epoch=1000
    env.after(100, update(epoch))  # Or just update()
    env.mainloop()
