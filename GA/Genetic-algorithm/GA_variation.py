...
def main():
    img = cv2.imread("C:/Users/szh/Desktop/szh/Python_test/GA/Genetic-algorithm/chrome.jpg")
    target_channels(img)
    Shell_1 = shell()
    ...
    dirpath = "C:/Users/szh/Desktop/szh/Python_test/GA/Genetic-algorithm/chrome"
