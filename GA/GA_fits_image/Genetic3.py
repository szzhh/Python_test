...
def SavePic(gene, generation, ori_img):
    ...
    for j, row in enumerate(gene):
        for i, col in enumerate(row):
            r = col
            img.putpixel((i, j), r[0])
    img.save("C:/Users/szh/Desktop/szh/Python_test/GA/GA_fits_image/4/{}.png".format(generation))
...
if __name__ == '__main__':
	# 备份
	backup = 'C:/Users/szh/Desktop/szh/Python_test/GA/GA_fits_image/4/backup.tmp'
	# 原始图像
	ori_img ='C:/Users/szh/Desktop/szh/Python_test/GA/GA_fits_image/4.bmp'
	# resume为True则读取备份文件，在其基础上进行自然选择，交叉变异
	run(ori_img, backup, resume=True)
